...
Z_Init(void) {
	...
	// set the entire zone to one free block
	mainzone->blocklist.next = mainzone->blocklist.prev = block = (memblock_t *)((uint8_t *)mainzone + sizeof(memzone_t));
