...
AM_drawFline(fline_t *fl,
	...
	if(fl->a.x < 0 || fl->a.x >= f_w
		...
		|| fl->b.x < 0 || fl->b.x >= f_w
		|| fl->b.y < 0 || fl->b.y >= f_h) {
		fprintf(stderr, "AM_drawFline: fuck %d \r", fuck++);
		return;
	}
#endif
...
void
AM_drawLineCharacter(mline_t *lineguy,
	int lineguylines,
	fixed_t scale,
	angle_t angle,
	int color,
